...
// XXX(CFS) Nice values for threads: Can range from 1 onwards.
// Of course, this project assumes all threads are Nice 1.
#define DEFAULT_NICE_VALUE 1
...
// XXX(CFS): This entire runquee is replaced with an RB tree
...
typedef struct __kthread_runqueue
{
	...
	unsigned int reserved0;
        // TODO: Figure out whether we need zombie stuff
...
// XXX(CFS): No group scheduling in this project, so commented out.
